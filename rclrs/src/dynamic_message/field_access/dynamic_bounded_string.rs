...
impl<'msg> AsMut<[libc::c_char]> for DynamicBoundedStringMut<'msg> {
    fn as_mut(&mut self) -> &mut [libc::c_char] {
...
impl<'msg> AsMut<[libc::c_ushort]> for DynamicBoundedWStringMut<'msg> {
    fn as_mut(&mut self) -> &mut [libc::c_ushort] {
        self.inner.deref_mut()
    }
}
